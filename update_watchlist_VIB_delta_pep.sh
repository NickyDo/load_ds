...
$KYC_ROOT/system/watchlist/batch/start_update_WorldCheck.sh VNVX output.csv $KYC_ROOT/custom/tool/wckall_pep.properties -charsetUTF-8 -verbose -showwarning -charset UTF8 -deltalist
