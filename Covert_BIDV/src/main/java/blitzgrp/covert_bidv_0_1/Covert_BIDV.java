...
package blitzgrp.covert_bidv_0_1;
...
/**
 * Job: Covert_BIDV Purpose: Bito<br>
 * Description: This is convert private watchlist BIDV <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Covert_BIDV implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Covert_BIDV";
	private final String projectName = "BLITZGRP";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Covert_BIDV.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_BLITZGRP_Covert_BIDV = new byte[0];
    static byte[] commonByteArray_BLITZGRP_Covert_BIDV = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BLITZGRP_Covert_BIDV.length) {
				if(length < 1024 && commonByteArray_BLITZGRP_Covert_BIDV.length == 0) {
   					commonByteArray_BLITZGRP_Covert_BIDV = new byte[1024];
				} else {
   					commonByteArray_BLITZGRP_Covert_BIDV = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BLITZGRP_Covert_BIDV, 0, length);
			strReturn = new String(commonByteArray_BLITZGRP_Covert_BIDV, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BLITZGRP_Covert_BIDV) {
...
public static class mapStruct implements routines.system.IPersistableRow<mapStruct> {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final mapStruct other = (mapStruct) obj;
	...
	public void copyDataTo(mapStruct other) {
	...
	public void copyKeysDataTo(mapStruct other) {
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:DlT5X4RyfuVpm4M4cyCqkB6DdTq3rl5KCl870w==");
 ...
 */
    ...
    public static void main(String[] args){
        final Covert_BIDV Covert_BIDVClass = new Covert_BIDV();

        int exitCode = Covert_BIDVClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Covert_BIDV.class.getClassLoader().getResourceAsStream("blitzgrp/covert_bidv_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Covert_BIDV.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Covert_BIDV");
        }
...
/************************************************************************************************
 *     156645 characters generated by Talend Open Studio for Data Integration 
 *     on the July 27, 2020 5:40:54 AM ICT
 ************************************************************************************************/