...
$KYC_ROOT/system/watchlist/batch/start_update_WorldCheck.sh VNVX output.csv $KYC_ROOT/custom/tool/wckall_pep.properties -verbose -showwarning -charset UTF8 -delete
