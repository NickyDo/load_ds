...
package newpro.vib_validate_input_0_1;
...
/**
 * Job: VIB_Validate_Input Purpose: VIB_Validate_Input<br>
 * Description: VIB_Validate_Input <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class VIB_Validate_Input implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(errorEntries != null){
					...
					this.setProperty("errorEntries", errorEntries.toString());
				
			}
			
			if(temp != null){
				
					this.setProperty("temp", temp.toString());
	...
	private final String jobName = "VIB_Validate_Input";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				VIB_Validate_Input.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(VIB_Validate_Input.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class consoleStruct implements routines.system.IPersistableRow<consoleStruct> {
    final static byte[] commonByteArrayLock_NEWPRO_VIB_Validate_Input = new byte[0];
    static byte[] commonByteArray_NEWPRO_VIB_Validate_Input = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_NEWPRO_VIB_Validate_Input.length) {
				if(length < 1024 && commonByteArray_NEWPRO_VIB_Validate_Input.length == 0) {
   					commonByteArray_NEWPRO_VIB_Validate_Input = new byte[1024];
				} else {
   					commonByteArray_NEWPRO_VIB_Validate_Input = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_NEWPRO_VIB_Validate_Input, 0, length);
			strReturn = new String(commonByteArray_NEWPRO_VIB_Validate_Input, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_NEWPRO_VIB_Validate_Input) {
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:7WKCJIHXl1gizC6GwwKS9ZMSmXNQSGzUfmRxxg==");
		...
		Object source_tFileInputExcel_3 = context.excelPath;
	...
	if(sheetList_tFileInputExcel_3.size()>0){
        ...
        int start_column_tFileInputExcel_3 = 0;
        ...
        for(int i_tFileInputExcel_3 = begin_line_tFileInputExcel_3; i_tFileInputExcel_3 < end_line_tFileInputExcel_3; i_tFileInputExcel_3++){
            ...
            if (rowCount_tFileInputExcel_3 <= i_tFileInputExcel_3 && i_tFileInputExcel_3 - rowCount_tFileInputExcel_3 >= (begin_line_tFileInputExcel_3)
            	&& currentRows_tFileInputExcel_3 - footer_input_tFileInputExcel_3 > i_tFileInputExcel_3 - rowCount_tFileInputExcel_3) {
                row_tFileInputExcel_3 = sheet_tFileInputExcel_3.getRow(i_tFileInputExcel_3 - rowCount_tFileInputExcel_3);
            }else{
            	continue;
            }
		    row1 = null;
					int tempRowLength_tFileInputExcel_3 = 12;
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				...
				row1.ID = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row1.ID = null;
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "AML_NAME";

				row1.AML_NAME = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row1.AML_NAME = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "AML_SOURCE";

				row1.AML_SOURCE = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "AML_TYPE";

				row1.AML_TYPE = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row1.AML_TYPE = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "DOB";

				if(4<actual_end_column_tFileInputExcel_3){
					try{
						if(row_tFileInputExcel_3.getCell(columnIndex_tFileInputExcel_3+ start_column_tFileInputExcel_3).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_3.getCell(columnIndex_tFileInputExcel_3+ start_column_tFileInputExcel_3))){
							row1.DOB = row_tFileInputExcel_3.getCell(columnIndex_tFileInputExcel_3+ start_column_tFileInputExcel_3).getDateCellValue();
						}
						else{
                            ...
                            if(tempDate_tFileInputExcel_3.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_3.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row1.DOB = tempDate_tFileInputExcel_3;
                            }
						}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "ADDRESS";

				row1.ADDRESS = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row1.ADDRESS = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "ID_Number";

				row1.ID_Number = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row1.ID_Number = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "ID_Type";

				row1.ID_Type = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row1.ID_Type = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "COUNTRIES";

				row1.COUNTRIES = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row1.COUNTRIES = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "PLACE_OF_BIRTH";

				row1.PLACE_OF_BIRTH = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "AML_REF";

				row1.AML_REF = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row1.AML_REF = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "OTHER";

				row1.OTHER = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row1.OTHER = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
...
console_tmp.ID = row1.ID ;
console_tmp.AML_NAME = row1.AML_NAME ;
console_tmp.AML_SOURCE = row1.AML_SOURCE ;
console_tmp.AML_TYPE = row1.AML_TYPE ;
console_tmp.DOB = row1.DOB ;
console_tmp.ADDRESS = row1.ADDRESS ;
console_tmp.ID_Number = row1.ID_Number ;
console_tmp.ID_Type = row1.ID_Type ;
console_tmp.COUNTRIES = row1.COUNTRIES ;
console_tmp.PLACE_OF_BIRTH = row1.PLACE_OF_BIRTH ;
console_tmp.AML_REF = row1.AML_REF ;
console_tmp.OTHER = row1.OTHER ;
console = console_tmp;
// ###############################
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.temp)).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"UTF-8"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("AML_NAME");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("AML_SOURCE");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("AML_TYPE");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("DOB");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("ADDRESS");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("ID_Number");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("ID_Type");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("COUNTRIES");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("PLACE_OF_BIRTH");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("AML_REF");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("OTHER");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:cMz289rEplH9VBViBA4lYJbnqA/Owa0QLlc1vw==");
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        int start_column_tFileInputExcel_1 = 0;
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row5.ID = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.ID = null;
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row5.AML_NAME = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.AML_NAME = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row5.AML_SOURCE = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.AML_SOURCE = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row5.AML_TYPE = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.AML_TYPE = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
				...
				if(4<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							row5.DOB = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
                            ...
                            if(tempDate_tFileInputExcel_1.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_1.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row5.DOB = tempDate_tFileInputExcel_1;
                            }
						}
					}catch(java.lang.Exception e){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row5.ID_Number = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.ID_Number = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row5.ID_Type = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.ID_Type = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row5.COUNTRIES = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.COUNTRIES = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row5.PLACE_OF_BIRTH = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.PLACE_OF_BIRTH = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row5.AML_REF = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.AML_REF = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row5.OTHER = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row5.OTHER = null;
				emptyColumnCount_tFileInputExcel_1++;
			} row5 = null; 
        ...
        if(emptyColumnCount_tFileInputExcel_1 >= 12){
			...
			whetherReject_tFileInputExcel_1 = true;
					row5.errorMessage = e.getMessage() + " - Line: " + tos_count_tFileInputExcel_1+ " column: " + curColName_tFileInputExcel_1 + " (No. " + curColNum_tFileInputExcel_1 + ")";
			}
...
copyOfcopyOfmap_tmp.ID = row5.ID ;
copyOfcopyOfmap_tmp.AML_NAME = row5.AML_NAME ;
copyOfcopyOfmap_tmp.AML_SOURCE = row5.AML_SOURCE ;
copyOfcopyOfmap_tmp.AML_TYPE = row5.AML_TYPE ;
copyOfcopyOfmap_tmp.DOB = row5.DOB ;
copyOfcopyOfmap_tmp.ADDRESS = null;
copyOfcopyOfmap_tmp.ID_Number = null;
copyOfcopyOfmap_tmp.ID_Type = null;
copyOfcopyOfmap_tmp.COUNTRIES = null;
copyOfcopyOfmap_tmp.PLACE_OF_BIRTH = null;
copyOfcopyOfmap_tmp.AML_REF = null;
copyOfcopyOfmap_tmp.OTHER = null;
copyOfcopyOfmap_tmp.errorCode = row5.errorCode ;
copyOfcopyOfmap_tmp.errorMessage = row5.errorMessage ;
...
if(copyOfcopyOfmap != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"copyOfcopyOfmap");
					}
					


                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(copyOfcopyOfmap.ID != null) {
                        sb_tFileOutputDelimited_1.append(
                            copyOfcopyOfmap.ID
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(copyOfcopyOfmap.AML_NAME != null) {
                        sb_tFileOutputDelimited_1.append(
                            copyOfcopyOfmap.AML_NAME
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(copyOfcopyOfmap.AML_SOURCE != null) {
                        sb_tFileOutputDelimited_1.append(
                            copyOfcopyOfmap.AML_SOURCE
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(copyOfcopyOfmap.AML_TYPE != null) {
                        sb_tFileOutputDelimited_1.append(
                            copyOfcopyOfmap.AML_TYPE
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(copyOfcopyOfmap.DOB != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(copyOfcopyOfmap.DOB, "dd/MM/yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(copyOfcopyOfmap.ADDRESS != null) {
                        sb_tFileOutputDelimited_1.append(
                            copyOfcopyOfmap.ADDRESS
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(copyOfcopyOfmap.ID_Number != null) {
                        sb_tFileOutputDelimited_1.append(
                            copyOfcopyOfmap.ID_Number
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(copyOfcopyOfmap.ID_Type != null) {
                        sb_tFileOutputDelimited_1.append(
                            copyOfcopyOfmap.ID_Type
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(copyOfcopyOfmap.COUNTRIES != null) {
                        sb_tFileOutputDelimited_1.append(
                            copyOfcopyOfmap.COUNTRIES
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(copyOfcopyOfmap.PLACE_OF_BIRTH != null) {
                        sb_tFileOutputDelimited_1.append(
                            copyOfcopyOfmap.PLACE_OF_BIRTH
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(copyOfcopyOfmap.AML_REF != null) {
                        sb_tFileOutputDelimited_1.append(
                            copyOfcopyOfmap.AML_REF
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(copyOfcopyOfmap.OTHER != null) {
                        sb_tFileOutputDelimited_1.append(
                            copyOfcopyOfmap.OTHER
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(copyOfcopyOfmap.errorCode != null) {
                        sb_tFileOutputDelimited_1.append(
                            copyOfcopyOfmap.errorCode
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(copyOfcopyOfmap.errorMessage != null) {
                        sb_tFileOutputDelimited_1.append(
                            copyOfcopyOfmap.errorMessage
                        );
                            }
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File(context.errorEntries)).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_2 != null && directory_tFileOutputDelimited_2.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_2, false),"UTF-8"));
                                    if(filetFileOutputDelimited_2.length()==0){
                                        ...
                                        outtFileOutputDelimited_2.write("AML_NAME");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("AML_SOURCE");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("AML_TYPE");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("DOB");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("ADDRESS");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("ID_Number");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("ID_Type");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("COUNTRIES");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("PLACE_OF_BIRTH");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("AML_REF");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("OTHER");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = context.temp;
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.temp, "UTF-8","\t","\n",false,1,0,
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
							...
							row4.ID = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 1;
					
							row4.AML_NAME = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 2;
					
							row4.AML_SOURCE = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							row4.AML_TYPE = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 4;
					
							row4.DOB = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 5;
					
							row4.ADDRESS = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 6;
					
							row4.ID_Number = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 7;
					
							row4.ID_Type = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 8;
					
							row4.COUNTRIES = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 9;
					
							row4.PLACE_OF_BIRTH = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 10;
					
							row4.AML_REF = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 11;
					
							row4.OTHER = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
copyOfmap_tmp.ID = row4.ID ;
copyOfmap_tmp.AML_NAME = row6.AML_NAME ;
copyOfmap_tmp.AML_SOURCE = row6.AML_SOURCE ;
copyOfmap_tmp.AML_TYPE = row6.AML_TYPE ;
copyOfmap_tmp.DOB = row6.DOB ;
copyOfmap_tmp.ADDRESS = row6.ADDRESS ;
copyOfmap_tmp.ID_Number = row6.ID_Number ;
copyOfmap_tmp.ID_Type = row6.ID_Type ;
copyOfmap_tmp.COUNTRIES = row6.COUNTRIES ;
copyOfmap_tmp.PLACE_OF_BIRTH = row6.PLACE_OF_BIRTH ;
copyOfmap_tmp.AML_REF = row6.AML_REF ;
copyOfmap_tmp.OTHER = row6.OTHER ;
copyOfmap_tmp.ERROR = row4.errorMessage ;
...
if(copyOfmap != null) { 
	...
	currentComponent="tFileOutputDelimited_2";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"copyOfmap");
					}
					


                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                            if(copyOfmap.ID != null) {
                        sb_tFileOutputDelimited_2.append(
                            copyOfmap.ID
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(copyOfmap.AML_NAME != null) {
                        sb_tFileOutputDelimited_2.append(
                            copyOfmap.AML_NAME
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(copyOfmap.AML_SOURCE != null) {
                        sb_tFileOutputDelimited_2.append(
                            copyOfmap.AML_SOURCE
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(copyOfmap.AML_TYPE != null) {
                        sb_tFileOutputDelimited_2.append(
                            copyOfmap.AML_TYPE
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(copyOfmap.DOB != null) {
                        sb_tFileOutputDelimited_2.append(
                            copyOfmap.DOB
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(copyOfmap.ADDRESS != null) {
                        sb_tFileOutputDelimited_2.append(
                            copyOfmap.ADDRESS
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(copyOfmap.ID_Number != null) {
                        sb_tFileOutputDelimited_2.append(
                            copyOfmap.ID_Number
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(copyOfmap.ID_Type != null) {
                        sb_tFileOutputDelimited_2.append(
                            copyOfmap.ID_Type
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(copyOfmap.COUNTRIES != null) {
                        sb_tFileOutputDelimited_2.append(
                            copyOfmap.COUNTRIES
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(copyOfmap.PLACE_OF_BIRTH != null) {
                        sb_tFileOutputDelimited_2.append(
                            copyOfmap.PLACE_OF_BIRTH
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(copyOfmap.AML_REF != null) {
                        sb_tFileOutputDelimited_2.append(
                            copyOfmap.AML_REF
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(copyOfmap.OTHER != null) {
                        sb_tFileOutputDelimited_2.append(
                            copyOfmap.OTHER
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(copyOfmap.ERROR != null) {
                        sb_tFileOutputDelimited_2.append(
                            copyOfmap.ERROR
                        );
                            }
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(context.temp) instanceof java.io.InputStream)){
...
System.out.println("Validated Failed!!! Please correct error entries in "+ context.errorEntries);
...
public static class row6Struct implements routines.system.IPersistableComparableLookupRow<row6Struct> {
	...
	public void copyDataTo(row6Struct other) {
		...
		other.ID = this.ID;
	            other.AML_NAME = this.AML_NAME;
	            other.AML_SOURCE = this.AML_SOURCE;
	            other.AML_TYPE = this.AML_TYPE;
	            other.DOB = this.DOB;
	            other.ADDRESS = this.ADDRESS;
	            other.ID_Number = this.ID_Number;
	            other.ID_Type = this.ID_Type;
	            other.COUNTRIES = this.COUNTRIES;
	            other.PLACE_OF_BIRTH = this.PLACE_OF_BIRTH;
	            other.AML_REF = this.AML_REF;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.AML_NAME = readString(dis,ois);
					
						this.AML_SOURCE = readString(dis,ois);
					
						this.AML_TYPE = readString(dis,ois);
					
						this.DOB = readString(dis,ois);
					
						this.ADDRESS = readString(dis,ois);
					
						this.ID_Number = readString(dis,ois);
					
						this.ID_Type = readString(dis,ois);
					
						this.COUNTRIES = readString(dis,ois);
					
						this.PLACE_OF_BIRTH = readString(dis,ois);
					
						this.AML_REF = readString(dis,ois);
					
						this.OTHER = readString(dis,ois);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.AML_NAME, dos, oos);
					
						writeString(this.AML_SOURCE, dos, oos);
					
						writeString(this.AML_TYPE, dos, oos);
					
						writeString(this.DOB, dos, oos);
					
						writeString(this.ADDRESS, dos, oos);
					
						writeString(this.ID_Number, dos, oos);
					
						writeString(this.ID_Type, dos, oos);
					
						writeString(this.COUNTRIES, dos, oos);
					
						writeString(this.PLACE_OF_BIRTH, dos, oos);
					
						writeString(this.AML_REF, dos, oos);
					
						writeString(this.OTHER, dos, oos);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row6";
		...
		int tos_count_tAdvancedHash_row6 = 0;
			   		...
			   		// source node:tFileInputExcel_2 - inputs:(after_tFileInputDelimited_1) outputs:(row6,row6) | target node:tAdvancedHash_row6 - inputs:(row6) outputs:()
			   		// linked node: tMap_2 - inputs:(row4,row6) outputs:(copyOfmap)
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:M9Q6humcUZY87oAYxtVAaKeHPciVRPAKxnwt+Q==");
	...
	if(sheetList_tFileInputExcel_2.size()>0){
        ...
        int start_column_tFileInputExcel_2 = 0;
        ...
        for(int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++){
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row6.ID = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row6.ID = null;
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "AML_NAME";

				row6.AML_NAME = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row6.AML_NAME = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "AML_SOURCE";

				row6.AML_SOURCE = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row6.AML_SOURCE = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "AML_TYPE";

				row6.AML_TYPE = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row6.AML_TYPE = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "DOB";

				row6.DOB = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row6.DOB = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row6.ADDRESS = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row6.ADDRESS = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "ID_Number";

				row6.ID_Number = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row6.ID_Number = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "ID_Type";

				row6.ID_Type = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row6.ID_Type = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "COUNTRIES";

				row6.COUNTRIES = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row6.COUNTRIES = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "PLACE_OF_BIRTH";

				row6.PLACE_OF_BIRTH = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row6.PLACE_OF_BIRTH = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "AML_REF";

				row6.AML_REF = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row6.AML_REF = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "OTHER";

				row6.OTHER = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row6.OTHER = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
...
if(row6 != null) { 
	...
	currentComponent="tAdvancedHash_row6";
				...
				row6_HashRow.AML_NAME = row6.AML_NAME;
				
				row6_HashRow.AML_SOURCE = row6.AML_SOURCE;
				
				row6_HashRow.AML_TYPE = row6.AML_TYPE;
				
				row6_HashRow.DOB = row6.DOB;
				
				row6_HashRow.ADDRESS = row6.ADDRESS;
				
				row6_HashRow.ID_Number = row6.ID_Number;
				
				row6_HashRow.ID_Type = row6.ID_Type;
				
				row6_HashRow.COUNTRIES = row6.COUNTRIES;
				
				row6_HashRow.PLACE_OF_BIRTH = row6.PLACE_OF_BIRTH;
				
				row6_HashRow.AML_REF = row6.AML_REF;
				
				row6_HashRow.OTHER = row6.OTHER;
 ...
 */
    ...
    public static void main(String[] args){
        final VIB_Validate_Input VIB_Validate_InputClass = new VIB_Validate_Input();

        int exitCode = VIB_Validate_InputClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = VIB_Validate_Input.class.getClassLoader().getResourceAsStream("newpro/vib_validate_input_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = VIB_Validate_Input.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        context.setContextType("errorEntries", "id_File");
                            context.errorEntries=(String) context.getProperty("errorEntries");
                        context.setContextType("temp", "id_File");
                            context.temp=(String) context.getProperty("temp");
                } 
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("excelPath")) {
            ...
            }if (parentContextMap.containsKey("errorEntries")) {
                context.errorEntries = (String) parentContextMap.get("errorEntries");
            }if (parentContextMap.containsKey("temp")) {
                context.temp = (String) parentContextMap.get("temp");
            }
        }
...
try {
errorCode = null;tFileInputExcel_3Process(globalMap);
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : VIB_Validate_Input");
        }
...
/************************************************************************************************
 *     206810 characters generated by Talend Open Studio for Data Integration 
 *     on the September 4, 2020 3:45:14 PM ICT
 ************************************************************************************************/